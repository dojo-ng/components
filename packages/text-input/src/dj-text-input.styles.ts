...
export default css`
	...
	.control {
		...
		padding: 0 var(--dj-spacing-small, 0.75rem);
	...
	.control--focused {
		...
		box-shadow: 0 0 0 1px var(--dj-color-primary-600, #2563eb);
	}
	.control--invalid { border-color: var(--dj-color-danger-600, #dc2626); }
	.control--invalid.control--focused { box-shadow: 0 0 0 1px var(--dj-color-danger-600, #dc2626); }
	...
	.input {
		...
		font-size: var(--dj-font-size-medium, 1rem);
		line-height: 1.4;
	}
	.input::placeholder { color: var(--dj-color-text-muted, #6b7280); }
	.affix { display: inline-flex; align-items: center; color: var(--dj-color-text-muted, #6b7280); }
